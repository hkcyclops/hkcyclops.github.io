...
基於 GitHub Pages 的免費靜態站點，收錄三個保險／理財計算工具，採用統一的 AIA 紅／炭黑視覺風格。

## 站點內容（三個工具）

| 頁面 | 工具 | 說明 |
|------|------|------|
| `index.html` | 封面首頁 | 三個工具的入口，含品牌 hero 與黑色表頭導覽 |
...
每頁黑色表頭內都內嵌三個工具連結（當前頁以紅色藥丸高亮），可直接互跳；右上角「← 返回首頁」回到 `index.html`。
